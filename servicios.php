...
<div class="container">
    ...
    <form name="form1" onSubmit="return Validar()"  method="GET" action="valoracion.php">
    <!-- Primera Fila -->
        <div class="row">
        ...
        <!-- Bloque de Cirugía Pediátrica -->
            <div class="col-md-3">
                ...
                <div class="card-body"> 
                    <h1 align="center">
                    <label class="btn btn-secondary" >
                        <input type="radio" name="options" id="option1" autocomplete="off" value="Televsión" > Televisión
                    </label>
                    </h1>
                </div>
                </div>
    ...
    <!-- Bloque de Urología -->
        <div class="col-md-3">
            <div class="card h-43" style="width: 18rem">
            <img class="card-img-top" src="images/whats.jpg" alt="Card image cap" width="120" height="150">
            <div class="card-body"> 
                <h1 align="center">
                <label class="btn btn-secondary" >
                    <input type="radio" name="options" id="option1" autocomplete="off" value="Whatsapp" > Whatsapp
                </label>
                </h1>
            </div>
            </div>
...
<?php
    ...
    $ultimoPaciente = $fila['paciente_idpaciente'];

    $conexion->query("INSERT INTO $tabla_db2(paciente_idpaciente,evento) values ('$ultimoPaciente','$evento')");
